...
L.Control.RiskThresholdHandler = L.Control.extend({
  ...
  _initLayout: function (map) {
    ...
    let statusLabel = L.DomUtil.create('div', this._base_classname + '-status');
    statusLabel.className = 'status-label';
    statusLabel.innerHTML = lastDateStatus;
    form.appendChild(statusLabel);

    let dateLabel = L.DomUtil.create('div', this._base_classname + '-status-date');
    dateLabel.className = 'status-date-label';
    dateLabel.innerHTML =  last_date;
